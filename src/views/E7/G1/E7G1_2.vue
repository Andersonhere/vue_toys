...
export default {
    ...
    data() {
        return {
            imageList: [
                { src: require('../../../assets/1024/E7H蓝梯形.png'), x: 50, y: 100, alt: 'b' },
                { src: require('../../../assets/1024/E7H红梯形.png'), x: 200, y: 100, alt: 'r' },
                ...
                { src: require('../../../assets/1024/E7H绿矩形.png'), x: 950, y: 100, alt: 'l' },
                { src: require('../../../assets/1024/E7H绿圆形.png'), x: 1100, y: 100, alt: 'l' },
            ],
            imageList1: [
