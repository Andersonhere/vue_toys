...
export default {
    ...
    data() {
        return {
            imageList: [
                { src: require('../../../assets/1024/E7H紫矩形.png'), x: 50, y: 100, alt: 'y' },
                { src: require('../../../assets/1024/E7H橙矩形.png'), x: 200, y: 100, alt: 'g' },
                ...
                { src: require('../../../assets/1024/E7H绿三角形.png'), x: 950, y: 100, alt: 'y' },
                { src: require('../../../assets/1024/E7H绿矩形.png'), x: 1100, y: 100, alt: 'y' },
            ],
            imageList1: [
