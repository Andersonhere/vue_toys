    ...
    data() {
        return {
            imageList: [
                ...
                { src: require('../../../assets/1024/E7H黄矩形.png'), x: 200, y: 100, alt: 'y' },
                { src: require('../../../assets/1024/E7H蓝矩形.png'), x: 350, y: 100, alt: 'b' },
                { src: require('../../../assets/1024/E7H红三角形.png'), x: 500, y: 100, alt: 'r' },
                { src: require('../../../assets/1024/E7H黄三角形.png'), x: 650, y: 100, alt: 'y' },
                { src: require('../../../assets/1024/E7H蓝三角形.png'), x: 800, y: 100, alt: 'b' },
                { src: require('../../../assets/1024/E7H红矩形.png'), x: 950, y: 100, alt: 'r' },
                { src: require('../../../assets/1024/E7H蓝三角形.png'), x: 1100, y: 100, alt: 'b' },
            ],
            imageList1: [
