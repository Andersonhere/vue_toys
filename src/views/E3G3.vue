...
export default {
    ...
    data() {
        return {
            imageList: [
                { src: require('../assets/0524/黄色矩形有纹理.png'), x: 50, y: 100, alt: '1' },
                { src: require('../assets/0524/绿色三角形.png'), x: 200, y: 100, alt: '0' },
                { src: require('../assets/0524/绿色矩形有纹理.png'), x: 350, y: 100, alt: '1' },
                { src: require('../assets/0524/黄色三角形.png'), x: 500, y: 100, alt: '0' },
                { src: require('../assets/0524/绿色矩形.png'), x: 650, y: 100, alt: '0' },
                { src: require('../assets/0524/绿色三角形有纹理.png'), x: 800, y: 100, alt: '1' },
                { src: require('../assets/0524/黄色矩形.png'), x: 950, y: 100, alt: '0' },
                { src: require('../assets/0524/黄色三角形有纹理.png'), x: 1100, y: 100, alt: '1' },
            ],
            imageList1: [
