    ...
    data() {
        return {
            imageList: [
                ...
                { src: require('../../../assets/0606/E2土黄矩形.png'), x: 200, y: 100, alt: 'o' },
                { src: require('../../../assets/0606/E2E8H天蓝矩形.png'), x: 350, y: 100, alt: 'o' },
                { src: require('../../../assets/0606/E2天蓝圆形.png'), x: 500, y: 100, alt: 'b' },
