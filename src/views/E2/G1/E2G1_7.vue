...
export default {
    ...
    data() {
        return {
            imageList: [
                { src: require('../../../assets/0524/橙色圆形.png'), x: 50, y: 100, alt: 'o' },
                ...
                { src: require('../../../assets/0524/黄色星形.png'), x: 650, y: 100, alt: 'y' },
                { src: require('../../../assets/0524/蓝色星.png'), x: 800, y: 100, alt: 'b' },
            ],
            draggingIndex: null,
            offsetX: 0,
            offsetY: 0,
