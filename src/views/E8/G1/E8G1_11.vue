    ...
    data() {
        return {
            imageList: [
                ...
                { src: require('../../../assets/0823/E8H蓝三角有花纹.png'), x: 200, y: 100, alt: 'g' },
                ...
                // { src: require('../../../assets/0823/E8H橙矩形有花纹.png'), x: 800, y: 100, alt: 'o' },
                { src: require('../../../assets/0823/E8H橙矩形有花纹.png'), x: 950, y: 100, alt: 'l' },
                { src: require('../../..//assets/0823/E8H橙三角无花纹.png'), x: 1100, y: 100, alt: 'l' },
            ],
            imageList1: [
