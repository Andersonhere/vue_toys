        ...
        <div class="image-container">
            ...
            <div class="link-container">
                <!-- <div class="hint-buttons">
                    <a href="/E8G3_2" class="hint-btn">One</a>
                    <a href="/E8G3_2" class="hint-btn">Two</a>
                </div> -->
                <router-link to="/E8G3_2">
...
export default {
    ...
    data() {
        return {
            imageList: [
                // { src: require('../../../assets/0823/E8H橙矩形有花纹.png'), x: 50, y: 100, alt: 'h' },
                // { src: require('../../../assets/0606/E3E8H红三角形.png'), x: 200, y: 100, alt: 'g' },
                { src: require('../../../assets/0823/E8H黄矩形有花纹.png'), x: 350, y: 100, alt: 'h' },
                // { src: require('../../../assets/0524/黄色三角形.png'), x: 500, y: 100, alt: 'y' },
                { src: require('../../../assets/0823/E8H黄矩形有花纹.png'), x: 650, y: 100, alt: 'h' },
                // { src: require('../../../assets/0524/绿色三角形有纹理.png'), x: 800, y: 100, alt: 'g' },
                // { src: require('../../../assets/0606/E8H红梯形.png'), x: 950, y: 100, alt: 'h' },
