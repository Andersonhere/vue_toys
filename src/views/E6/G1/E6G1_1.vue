...
export default {
    ...
    data() {
        return {
            imageList: [
                { src: require('../../../assets/0606/E2土黄矩形.png'), x: 50, y: 100, alt: 'j' },
                { src: require('../../../assets/0606/E2土黄矩形.png'), x: 200, y: 100, alt: 'j' },
                { src: require('../../../assets/0606/E2E8H天蓝矩形.png'), x: 350, y: 100, alt: 'j' },
                { src: require('../../../assets/0606/E2土黄三角形.png'), x: 500, y: 100, alt: 'san' },
                { src: require('../../../assets/0606/E2E8H天蓝三角形.png'), x: 650, y: 100, alt: 'san' },
                { src: require('../../../assets/0606/E2E8H草绿三角形.png'), x: 800, y: 100, alt: 'san' },
            ],
            draggingIndex: null,
            offsetX: 0,
            offsetY: 0,
...
.drop-area {
    ...
    /* 目标高度 */
    /* 设置区域高度 */
    background-image: url('../../../assets/0524/灰色无花纹玩具.png');
