...
export default {
    ...
    data() {
        return {
            imageList: [
                { src: require('../../../assets/0606/E2E8H天蓝三角形.png'), x: 50, y: 100, alt: 'san' },
                { src: require('../../../assets/0606/E2E8H天蓝三角形.png'), x: 200, y: 100, alt: 'san' },
                { src: require('../../../assets/0606/E2E8H草绿三角形.png'), x: 350, y: 100, alt: 'san' },
                { src: require('../../../assets/0606/E2天蓝圆形.png'), x: 500, y: 100, alt: 'yuan' },
                { src: require('../../../assets/0606/E2E8H草绿圆形.png'), x: 650, y: 100, alt: 'yuan' },
                { src: require('../../../assets/0606/E2土黄圆形.png'), x: 800, y: 100, alt: 'yuan' },
            ],
            draggingIndex: null,
            offsetX: 0,
            offsetY: 0,
