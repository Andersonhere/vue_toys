...
export default {
    ...
    data() {
        return {
            imageList: [
                { src: require('../../../assets/0606/E2E8H草绿圆形.png'), x: 50, y: 100, alt: 'yuan' },
                { src: require('../../../assets/0606/E2E8H草绿圆形.png'), x: 200, y: 100, alt: 'yuan' },
                { src: require('../../../assets/0606/E2土黄圆形.png'), x: 350, y: 100, alt: 'yuan' },
                { src: require('../../../assets/0606/E2土黄矩形.png'), x: 500, y: 100, alt: 'j' },
                { src: require('../../../assets/0606/E2E8H草绿矩形.png'), x: 650, y: 100, alt: 'j' },
                { src: require('../../../assets/0606/E2E8H天蓝矩形.png'), x: 800, y: 100, alt: 'j' },
            ],
            draggingIndex: null,
            offsetX: 0,
            offsetY: 0,
...
.drop-area {
    ...
    /* 目标高度 */
    /* 设置区域高度 */
    background-image: url('../../../assets/0606/E2黄色无花纹玩具.png');
