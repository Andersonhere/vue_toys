...
export default {
    ...
    data() {
        return {
            imageList: [
                { src: require('../../../assets/0524/蓝色矩形.png'), x: 50, y: 100, alt: 'j' },
                { src: require('../../../assets/0524/红色圆形.png'), x: 200, y: 100, alt: 'y' },
                { src: require('../../../assets/0524/蓝色圆形.png'), x: 350, y: 100, alt: 'y' },
                { src: require('../../../assets/0524/红色三角形.png'), x: 500, y: 100, alt: 'san' },
                { src: require('../../../assets/0524/黄色矩形.png'), x: 650, y: 100, alt: 'j' },
                { src: require('../../../assets/0524/蓝色三角形.png'), x: 800, y: 100, alt: 'san' },
                { src: require('../../../assets/0524/黄色圆形.png'), x: 950, y: 100, alt: 'y' },
                { src: require('../../../assets/0524/黄色三角形.png'), x: 1100, y: 100, alt: 'san' },
            ],
            draggingIndex: null,
            offsetX: 0,
            offsetY: 0,
