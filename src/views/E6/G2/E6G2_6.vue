    ...
    data() {
        return {
            imageList: this.generateImageList(this.shuffleArray([
                { src: require('../../../assets/0524/蓝色矩形.png'), alt: 'j' },
                { src: require('../../../assets/0524/红色圆形.png'),  alt: 'y' },
                { src: require('../../../assets/0524/蓝色圆形.png'),  alt: 'y' },
                { src: require('../../../assets/0524/红色三角形.png'),  alt: 'san' },
                { src: require('../../../assets/0524/黄色矩形.png'), alt: 'j' },
                { src: require('../../../assets/0524/蓝色三角形.png'), alt: 'san' },
                { src: require('../../../assets/0524/黄色圆形.png'),  alt: 'y' },
                { src: require('../../../assets/0524/黄色三角形.png'),  alt: 'san' },
                ])),
            draggingIndex: null,
            offsetX: 0,
            offsetY: 0,
