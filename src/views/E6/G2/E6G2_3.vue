...
export default {
    ...
    data() {
        return {
            imageList: [
                { src: require('../../../assets/0606/E2E8H草绿圆形.png'), x: 50, y: 100, alt: 'l' },
                { src: require('../../../assets/0606/E2E8H草绿圆形.png'), x: 200, y: 100, alt: 'l' },
                { src: require('../../../assets/0606/E2紫色圆形.png'), x: 350, y: 100, alt: 'z' },
                { src: require('../../../assets/0606/E2紫色矩形.png'), x: 500, y: 100, alt: 'z' },
                { src: require('../../../assets/0606/E2E8H草绿矩形.png'), x: 650, y: 100, alt: 'l' },
                { src: require('../../../assets/0606/E2紫色三角形.png'), x: 800, y: 100, alt: 'z' },
            ],
            draggingIndex: null,
            offsetX: 0,
            offsetY: 0,
