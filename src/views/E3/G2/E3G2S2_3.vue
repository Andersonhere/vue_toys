...
export default {
    ...
    data() {
        return {
            imageList: [
                { src: require('../../../assets/0606/E3橘色矩形.png'), x: 50, y: 100, alt: 'r' },
                // { src: require('../../../assets/蓝色三角形.png'), x: 200, y: 100, alt: 'b' },
                { src: require('../../../assets/0606/E3E8H橘色三角形.png'), x: 200, y: 100, alt: 'l' },
                // { src: require('../../../assets/蓝色矩形.png'), x: 500, y: 100, alt: 'b' },
                { src: require('../../../assets/0606/E3土黄星形.png'), x: 800, y: 100, alt: 'r' },
                // { src: require('../../../assets/黄色三角形.png'), x: 800, y: 100, alt: 'y' },
                { src: require('../../../assets/0606/E3E8H草绿星形.png'), x: 950, y: 100, alt: 'r' },
