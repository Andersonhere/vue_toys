...
export default {
    ...
    data() {
        return {
            imageList: [
            { src: require('../../../assets/0606/E3E8H红矩形.png'), x: 50, y: 100, alt: 'j' },
                // { src: require('../../../assets/蓝色三角形.png'), x: 200, y: 100, alt: 'b' },
                { src: require('../../../assets/0606/E3E8H蓝矩形.png'), x: 350, y: 100, alt: 'j' },
                // { src: require('../../../assets/蓝色矩形.png'), x: 500, y: 100, alt: 'b' },
                { src: require('../../../assets/0606/E3E8H红三角形.png'), x: 650, y: 100, alt: 'san' },
                // { src: require('../../../assets/黄色三角形.png'), x: 800, y: 100, alt: 'y' },
                { src: require('../../../assets/0606/E3E8H红矩形.png'), x: 950, y: 100, alt: 'j' },
...
.drop-area {
    ...
    height: 150px; /* 目标高度 */
    /* 设置区域高度 */
    background-image: url('../../../assets/1024/E3G2-1.png');
