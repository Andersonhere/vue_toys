    ...
    data() {
        return {
            imageList: [
                ...
                { src: require('../../../assets/0606/E3土黄十字形.png'), x: 350, y: 100, alt: 'h' },
                // { src: require('../../../assets/蓝色矩形.png'), x: 500, y: 100, alt: 'b' },
                { src: require('../../../assets/0606/E3土黄L形.png'), x: 650, y: 100, alt: 'h' },
                // { src: require('../../../assets/黄色三角形.png'), x: 800, y: 100, alt: 'y' },
                { src: require('../../../assets/0606/E3E8H草绿十字形.png'), x: 950, y: 100, alt: 'l' },
