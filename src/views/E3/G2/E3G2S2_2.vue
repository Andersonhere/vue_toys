    ...
    data() {
        return {
            ...
            { src: require('../../../assets/0606/E2土黄矩形.png'), x: 50, y: 100, alt: 'j' },
                ...
                { src: require('../../../assets/0606/E2土黄三角形.png'), x: 350, y: 100, alt: 'san' },
                ...
                { src: require('../../../assets/0606/E2土黄矩形.png'), x: 950, y: 100, alt: 'j' },
...
.drop-area {
    ...
    height: 150px; /* 目标高度 */
    /* 设置区域高度 */
    background-image: url('../../../assets/1024/E3G2-2.png');
