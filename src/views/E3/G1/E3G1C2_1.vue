...
export default {
    ...
    data() {
        return {
            imageList: [
                { src: require('../../../assets/0606/E3E8H红L形.png'), x: 50, y: 100, alt: 'l' },
                // { src: require('../../../assets/蓝色三角形.png'), x: 200, y: 100, alt: 'b' },
                { src: require('../../../assets/0606/E3蓝十字形.png'), x: 350, y: 100, alt: 'shi' },
                // { src: require('../../../assets/蓝色矩形.png'), x: 500, y: 100, alt: 'b' },
                { src: require('../../../assets/0606/E3蓝L形.png'), x: 650, y: 100, alt: 'l' },
                // { src: require('../../../assets/黄色三角形.png'), x: 800, y: 100, alt: 'y' },
                { src: require('../../../assets/0606/E3红十字形.png'), x: 950, y: 100, alt: 'shi' },
