...
export default {
    ...
    data() {
        return {
            imageList: [
            { src: require('../../../assets/0606/E2土黄矩形.png'), x: 50, y: 100, alt: 'h' },
                // { src: require('../../../assets/蓝色三角形.png'), x: 200, y: 100, alt: 'b' },
                { src: require('../../../assets/0606/E2土黄三角形.png'), x: 350, y: 100, alt: 'h' },
                ...
                { src: require('../../../assets/0606/E2土黄矩形.png'), x: 950, y: 100, alt: 'h' },
