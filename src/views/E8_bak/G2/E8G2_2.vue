...
export default {
    ...
    data() {
        return {
            imageList: [
                { src: require('../../../assets/0606/E3E8H红三角形.png'), x: 50, y: 100, alt: 's' },
                // { src: require('../../../assets/0606/E3E8H红三角形.png'), x: 200, y: 100, alt: 'g' },
                { src: require('../../../assets/0606/E2E8H草绿三角形.png'), x: 350, y: 100, alt: 's' },
                // { src: require('../../../assets/0524/黄色三角形.png'), x: 500, y: 100, alt: 'y' },
                { src: require('../../../assets/0606/E8H蓝三角形.png'), x: 650, y: 100, alt: 's' },
                // { src: require('../../../assets/0524/绿色三角形有纹理.png'), x: 800, y: 100, alt: 'g' },
                { src: require('../../../assets/0606/E8H亮黄三角形.png'), x: 950, y: 100, alt: 's' },
