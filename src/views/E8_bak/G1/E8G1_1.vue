...
export default {
    ...
    data() {
        return {
            imageList: [
                { src: require('../../../assets/0606/E3E8H红矩形.png'), x: 50, y: 100, alt: 'h' },
                // { src: require('../../../assets/0606/E3E8H红三角形.png'), x: 200, y: 100, alt: 'g' },
                { src: require('../../../assets/0606/E3E8H红三角形.png'), x: 350, y: 100, alt: 'h' },
                // { src: require('../../../assets/0524/黄色三角形.png'), x: 500, y: 100, alt: 'y' },
                { src: require('../../../assets/0606/E8H红圆形.png'), x: 650, y: 100, alt: 'h' },
