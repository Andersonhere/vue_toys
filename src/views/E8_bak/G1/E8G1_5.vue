  ...
  ">
                    ...
                    <div class="option" style=" border: 2px solid #ccc;   padding: 15px; min-width: 200px; text-align: center;     /* 内部元素居中 */ ">
                        <div class="blocks" style="  display: flex;  gap: 10px; justify-content: center;  /* 图片居中 */ ">
                            <img src="../../../assets/0606/E3E8H草绿星形.png" alt="黄色网格方块"
                                style="width: 80px; height: 80px;" />
                            <img src="../../../assets/0606/E3E8H草绿十字形.png" alt="黄色网格三角" style="width: 80px; height: 80px;" />
                        </div>
                    ...
                    <div class="option"
                        ...
                        <div class="blocks" style="display: flex; gap: 10px; justify-content: center;">
                            <img src="../../../assets/0606/E2E8H天蓝矩形.png" alt="黄色网格方块" style="width: 80px; height: 80px;" />
                            <img src="../../../assets/0606/E2E8H天蓝三角形.png" alt="绿色实心方块"
                                style="width: 80px; height: 80px;" />
                        </div>
                    ...
                    <div class="option"
                        style="border: 2px solid #ccc; padding: 15px; min-width: 200px; text-align: center;">
                        <div class="blocks" style="display: flex; gap: 10px; justify-content: center;">
                            <img src="../../../assets/0606/E3E8H红L形.png" alt="绿色网格方块"
                                style="width: 80px; height: 80px;" />
                            <img src="../../../assets/0606/E8H红心形.png" alt="黄色网格三角"
                                style="width: 80px; height: 80px;" />
                        </div>
                    ...
                    <div class="option"
                        style="border: 2px solid #ccc; padding: 15px; min-width: 200px; text-align: center;">
                        <div class="blocks" style="display: flex; gap: 10px; justify-content: center;">
                            <img src="../../../assets/0606/E2E8H草绿圆形.png" alt="绿色网格方块"
                                style="width: 80px; height: 80px;" />
                            <img src="../../../assets/0606/E8H红梯形.png" alt="黄色网格三角"
                                style="width: 80px; height: 80px;" />
                        </div>
